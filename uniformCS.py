...
route_Ucs = Graph()
# routes = route_bfs.UCS(G,"SportsComplex","parkingLot",weight=[])

route_using_ucs =route_Ucs.ucs("Sports Complex","Parking Lot",)
print(route_using_ucs)



# # color the nodes in the route_bfs
node_col = ['darkturquoise' if not node in route_using_ucs else 'peru' for node in G.nodes()]
peru_colored_edges = list(zip(route_using_ucs,route_using_ucs[1:]))
